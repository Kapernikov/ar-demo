...
#ifndef __AR_DEMO__CAMERA_ADAPTER_BASLER_PYLON_USB
#define __AR_DEMO__CAMERA_ADAPTER_BASLER_PYLON_USB
...
namespace ar_demo {
  ...
  class BaslerPylonUsbCameraAdapter: public CameraAdapter {
    private:
    ...
    public:
      BaslerPylonUsbCameraAdapter(std::shared_ptr<const Configuration> configuration);
      virtual ~BaslerPylonUsbCameraAdapter();
...
#endif // __AR_DEMO__CAMERA_ADAPTER_BASLER_PYLON_USB
